                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(widget.etudiant.nom, style: TextStyle(color: Colors.white70),),
                    ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(widget.etudiant.prenom, style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(widget.etudiant.email, style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(widget.etudiant.numTel, style: TextStyle(color: Colors.white70),),
                    ),
                  ), decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.white70)),
                ),
              ),
